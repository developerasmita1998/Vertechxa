            ...
            <div className="row">
              ...
              <div className="col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000">
                <div className="widget justify-text">
                  ...
                  <p class="justify-text" style={{ fontSize: "16px" }}>An IoT development projects are everywhere,
                    and affordable,
                    advanced technology is the driving force
                    behind this fast-growing phenomenon.</p>
                  <p class="justify-text" style={{ fontSize: "16px" }}>The Internet of Things (IoT) describes the network of physical objects “things” that are embedded with sensors, software, and other technologies for the purpose of connecting and exchanging data with other devices and systems over
                   the internet.</p>
               </div>
              </div>
            </div>
