...
<p class="text-justify text-secondary" style={{fontSize: "16px"}}>Vertech<span style={{color:"#da251d"}}>xa</span> develop Proof of concept (PoC). PoC may also 
refer to partial solutions involving a small number of users acting in business roles to establish whether a system satisfies certain requirements. A PoC (proof of concept) is
 ...
 those requirements.</p>
  <p class="text-justify text-secondary" style={{fontSize: "16px"}}>PoC helps to avoid possible technical and 
