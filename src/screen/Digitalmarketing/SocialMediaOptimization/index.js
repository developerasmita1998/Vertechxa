...
import seo from "../../../assets/social-m.png";
          ...
          <div className="menu">
            <div className="row">
              <div className="col-md-12 col-sm-12">
                <h1 className="mb-5">Social Media Optimization</h1>
              </div>
            </div>
          </div>
        </div>
