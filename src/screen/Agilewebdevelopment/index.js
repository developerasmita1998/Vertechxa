            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="widget text-center">
                       ...
                       <p class="text-justify text-secondary" style={{fontSize: "16px"}}>Agile is a term used to describe approaches to software development 
...
of trying to deliver it all at once near the end.</p>
                         <p class="text-justify text-secondary" style={{fontSize: "16px"}}>Agile focuses on keeping the process
...
more dynamic process where everyone is working
 together towards one goal.</p>
                   <p class="text-justify text-secondary" style={{fontSize: "16px"}}>Agile processes generally promote 
